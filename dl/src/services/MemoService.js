...
class MemoService {
     ...
     */
    static decodeMemo(receiverPrivateMemo, senderPublicMemo, nonce, encryptedMessage) {
        ...
        let decryptedMessage = Aes.decrypt_with_checksum(receiverPrivateMemo, senderPublicMemo, nonce, encryptedMessage);
