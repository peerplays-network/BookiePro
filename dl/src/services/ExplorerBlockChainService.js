...
let {
  operations
} = require('peerplaysjs-lib').ChainTypes;
    ...
    switch (ops[newOperation.type]) {
      case 'game_move':
        newOperation.operation = {
          ...
          gesture: (operation[1] && operation[1]['move'] && operation[1]['move'][1]['gesture']) ?
            operation[1]['move'][1]['gesture'] :
            null
        };
        return newOperation;
      ...
      case 'asset_publish_feed': //19
        newOperation.operation = {
          ...
          quote_asset: fetchedObjects[
            operation[1]['feed']['settlement_price']['quote']['asset_id']
          ],
  ...
  static setNeededObjects(operation, neededObjects = {}) {
    ...
    switch (ops[operation[0]]) {
      ...
      case 'limit_order_create': //1
        ...
        if (isAsk) {
          neededObjects[operation[1]['min_to_receive']['asset_id']] =
            operation[1]['min_to_receive']['asset_id'];
          neededObjects[operation[1]['amount_to_sell']['asset_id']] =
            operation[1]['amount_to_sell']['asset_id'];
        } else {
          neededObjects[operation[1]['amount_to_sell']['asset_id']] =
            operation[1]['amount_to_sell']['asset_id'];
          neededObjects[operation[1]['min_to_receive']['asset_id']] =
      ...
      case 'call_order_update': //3
        ...
        neededObjects[operation[1].delta_collateral.asset_id] =
          operation[1].delta_collateral.asset_id;
        break;
      case 'account_create': //5
      ...
      case 'asset_reserve': //15
        ...
        neededObjects[operation[1].amount_to_reserve.asset_id] =
          operation[1].amount_to_reserve.asset_id;
        break;
      case 'asset_fund_fee_pool': //16
      ...
      case 'asset_publish_feed': //19
        ...
        neededObjects[operation[1]['feed']['settlement_price']['base']['asset_id']] =
          operation[1]['feed']['settlement_price']['base']['asset_id'];
        neededObjects[operation[1]['feed']['settlement_price']['quote']['asset_id']] =
          operation[1]['feed']['settlement_price']['quote']['asset_id'];
        break;
      case 'witness_update': //21
      ...
      case 'asset_claim_fees': //43
        neededObjects[operation[1].issuer] = operation[1].issuer;
        neededObjects[operation[1].amount_to_claim.asset_id] =
          operation[1].amount_to_claim.asset_id;
        break;
      default:
