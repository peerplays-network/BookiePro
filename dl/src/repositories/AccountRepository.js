...
class AccountRepository {
    ...
    static fetchFullAccount(accountIdOrName) {
        ...
        return Apis.instance().db_api().exec("get_full_accounts", [[accountIdOrName], true]).then((results) => {
    ...
    static updateMemo(account, activePublicKey) {
        return Promise.all([
            ...
            let [chain_account, chain_asset, chain_fee_asset] = res;
            ...
            let update_op = tr.get_type_operation('account_update', {
                ...
                owner: account.owner,
                active:  Object.assign({}, account.active, {key_auths: [[activePublicKey, 1]]}),
                new_options: Object.assign({}, account.options, {memo_key: activePublicKey})
            });
    ...
    static updateKeys(account, ownerKeyPublic, activeKeyPublic, memoKeyPublic) {
        return Promise.all([
            ...
            let update_op = tr.get_type_operation('account_update', {
                ...
                owner: Object.assign({}, account.owner, {key_auths: [[ownerKeyPublic, 1]]}),
                active:  Object.assign({}, account.active, {key_auths: [[activeKeyPublic, 1]]}),
                new_options: Object.assign({}, account.options, {memo_key: memoKeyPublic})
            });
