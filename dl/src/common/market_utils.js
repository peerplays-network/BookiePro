...
class MarketUtils {
    ...
    static parseOrder(order, base, quote, invert = false) {
        ...
        let price = utils.price_to_text(fullPrice, order.call_price ? base : quote, order.call_price ? quote : base, base.precision);
    ...
    static parse_order_history(order, paysAsset, receivesAsset, isAsk, flipped) {
        ...
        let receivePrecision = utils.get_asset_precision(receivesAsset.toJS ? receivesAsset.get("precision") : receivesAsset.precision);
        let payPrecision = utils.get_asset_precision(paysAsset.toJS ? paysAsset.get("precision") : paysAsset.precision);
        ...
        let price = utils.price_to_text(price_full, isAsk ? receivesAsset : paysAsset, isAsk ? paysAsset : receivesAsset, isAsk ? paysAsset.precision : receivesAsset.precision);
        let amount = utils.price_to_text((isAsk ? receives : pays), isAsk ? paysAsset : receivesAsset, isAsk ? receivesAsset : paysAsset, isAsk ? receivesAsset.precision : paysAsset.precision);
        let total = utils.price_to_text((isAsk ? pays : receives), isAsk ? receivesAsset : paysAsset, isAsk ? paysAsset : receivesAsset, isAsk ? paysAsset.precision : receivesAsset.precision );
