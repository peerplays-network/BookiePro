...
class RememberMeService {
  ...
  static checkNeedResetWallet() {
    return (
      Cookies.get('not_remember_me')
      && (!Cookies.get('remember_me_check_expire')
      || (sessionStorage && !sessionStorage['remember_me_check_expire']))
    );
  }
  ...
  static setRememberMe(public_name) {
    ...
    Cookies.set('remember_me_check_expire', public_name).set('not_remember_me', public_name, {
      expires: Infinity
    });
  }
