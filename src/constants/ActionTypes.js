...
export default {
  ...
  // Sport Actions
  SPORT_SET_LOADING_STATUS: 'SPORT_SET_LOADING_STATUS',
  SPORT_ADD_SPORTS: 'SPORT_ADD_SPORTS',
  // Event Group Actions
  EVENT_GROUP_SET_LOADING_STATUS: 'EVENT_GROUP_SET_LOADING_STATUS',
  EVENT_GROUP_ADD_EVENT_GROUPS: 'EVENT_GROUP_ADD_EVENT_GROUPS',
  // Competitor Actions
  COMPETITOR_SET_LOADING_STATUS: 'COMPETITOR_SET_LOADING_STATUS',
  COMPETITOR_ADD_COMPETITORS: 'COMPETITOR_ADD_COMPETITORS',
  // Event Group Actions
  EVENT_SET_LOADING_STATUS: 'EVENT_SET_LOADING_STATUS',
