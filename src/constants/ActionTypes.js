...
export default {
  ...
  //Transaction History loading setGetOngoingBetsLoadingStatusAction
  TRANSACTION_HISTORY_LOADING_STATUS: 'TRANSACTION_HISTORY_LOADING_STATUS',
  ...
  EVENT_GROUP_PAGE_SET_EVENT_IDS: 'EVENT_GROUP_PAGE_SET_EVENT_IDS',
  EVENT_GROUP_PAGE_SET_DATA: 'EVENT_GROUP_PAGE_SET_DATA',

  // Binned Order Books
  BINNED_ORDER_BOOK_ADD_BINNED_ORDER_BOOKS: 'BINNED_ORDER_BOOK_ADD_BINNED_ORDER_BOOKS',
