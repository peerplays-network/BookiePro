...
const Config = {
  ...
  dust: {
    exchangeCoin: 10.001, // On the simple betting widget, aggregated bets are displayed in their base coin (BTC, BTF, etc.) with a precision of three.
    coin: 10.00001,       // The base coin. ie: BTC, BTF, etc.
    miliCoin: 10.01       // The mili version of the base coin. ie: mBTC, mBTF, etc.
  },
  features: {
    withdrawels: false,
    deposits: false,
