...
const {reserved_spaces, object_type, impl_object_type} = ChainTypes;

const {protocol_ids, implementation_ids} = reserved_spaces;
...
const ObjectPrefix = {
  ...
  DYNAMIC_GLOBAL_PROPERTY_PREFIX:
    implementation_ids + '.' + impl_object_type.dynamic_global_property,
