...
export const translationsObject = {
  en: {
    ...
    changePassword:{
      ...
      enter_old_password_hint: 'Current Password: Please enter the Current Password.',
      enter_new_password_hint: 'New Password: The New Password must be at least 22 characters long.',
      confirm_new_password_hint: 'Confirm Password: Please enter the New Password again.',
