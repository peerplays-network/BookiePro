...
class MarketDrawerActions {
  ...
  static clickPlaceBet(totalBetAmount, currencyFormat) {
    ...
    return (dispatch, getState) => {
      dispatch(MarketDrawerActions.updateOpenBetsLoadingStatus(LoadingStatus.BET_PLACE));
  ...
  static getOpenBets(bettingMarketGroupId) {
    return (dispatch, getState) => {
      ...
      if (!bettingMarketGroup || bettingMarketGroup.isEmpty()) {
        ...
        dispatch(MarketDrawerActions.clearOpenBets());
      } else {
  ...
  static clearOpenBets() {
    return (dispatch) => {
      dispatch(MarketDrawerPrivateActions.updateOpenBetsLoadingStatus(LoadingStatus.BET_DELETE));
