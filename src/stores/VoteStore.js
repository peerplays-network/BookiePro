  ...
  getAccountJsonWithChanges(account_name) {
    ...
    let votes = []
      .concat(this.listToVoteOptions(
        COMMITTEE_MEMBER, this.c_committee_members[account_name], account_name_to_id
      ))
      .concat(this.listToVoteOptions(
        WITNESS, this.c_witnesses[account_name], account_name_to_id
      ))
      .concat(this.listToVoteOptions(
