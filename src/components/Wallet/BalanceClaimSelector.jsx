...
export default class BalanceClaimSelector extends Component {
  ...
  static getPropsFromStores() {
    ...
    if (balances) {
      props.total_by_account_asset = balances.groupBy((v) => {
        // K E Y S
        var names = '';
        ...
        <table className='table'>
          <thead>
            <tr>
              ...
              <th style={ {
                textAlign: 'center'
              } }><Translate content='wallet.unclaimed'/></th>
              <th style={ {
                textAlign: 'center'
              } }><Translate content='wallet.unclaimed_vesting'/></th>
              <th style={ {
                textAlign: 'center'
              } }><Translate content='account.name'/></th>
            </tr>
          </thead>
          <tbody>
            {
