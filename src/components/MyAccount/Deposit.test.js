...
describe('Test cases on "Deposit" component',()=>{
  ...
  it('Check click event of Copy button', () => {
    ...
    It says:
    'You are trying to call 'copy-to-clipboard' when there's no interaction by user (clicks/keydowns, etc).
    Copy commands triggered from document.execCommand() will only affect the contents of the real clipboard
