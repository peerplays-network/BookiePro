 ...
 * AllSports (Home) and EventGroup components. It can display the best available
 * odds for multiple events (each even appears in its own row).
 *
 * The ComplexBettingWidget, also known as Full Market Betting Widget, is used in
 * the Sports component only. It show the best available odds for one event only
 * and has a more complex (hence the name) UI design than its "simple" counterpart.
 */
