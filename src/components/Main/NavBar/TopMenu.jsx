...
const mapStateToProps = (state) => {
  ...
  */
  ...
  let availableBalance = balance !== undefined ? convertAmount(balance, precision, setting.get('currencyFormat')).toFixed(setting.get('currencyFormat') === 'BTC' ? 6 : 0) : -1;
  ...
  inGameAmount = convertAmount(inGameAmount, precision, setting.get('currencyFormat'));
  inGameAmount = inGameAmount.toFixed(setting.get('currencyFormat') === 'BTC' ? 3 : 0);
