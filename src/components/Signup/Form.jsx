...
class SignUpForm extends React.Component {
  ...
  render() {
    const { handleSubmit, submitting, onClickLogin, errors, invalid, asyncValidating,serverError,loadingStatus } = this.props
    return (
          <form onSubmit={ handleSubmit }>
            <div className='form-fields'>
                ...
                <div>{ serverError ? <span className='errorText' key={ serverError }>{ serverError }</span>  : null }</div>
            </div>
            ...
            <div className='form-fields'>
                ...
                disabled={ invalid || submitting || asyncValidating || (loadingStatus==='loading' && serverError ==='') }
                >{ loadingStatus==='loading' && serverError ==='' ? 'loading ...' : 'create account' }</button>
            </div>
            <div className='form-fields'>
...
export default reduxForm({
  ...
  asyncValidate: (values) => {
    return RegisterActions.lookupAccounts(values.accountName, 100)
        .then(result => {
