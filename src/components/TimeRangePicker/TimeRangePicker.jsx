...
class TimeRangePicker extends PureComponent {
  constructor(props) {
    ...
    this.onCustomTimeRangePickerStartDateChange = this.onCustomTimeRangePickerStartDateChange.bind(
      this
    );
    this.onCustomTimeRangePickerEndDateChange = this.onCustomTimeRangePickerEndDateChange.bind(
      this
    );
  }
  ...
  onSearchClick(e) {
    ...
    this.props.onSearchClick(
      ...
      this.state.customTimeRangeStartDate,
      this.state.customTimeRangeEndDate
    );
  ...
  /**
   * This function is bound to the 'onChange' callback function of the 'From Date' 
   * datepicker control (antd)
  ...
  /**
   * This function is bound to the 'onChange' callback function of the 'To Date' 
   * datepicker control (antd)
  ...
  /**
   * This function is bound to the 'onChange' callback function of the 'Period' 
   * dropdown control (antd)
  ...
  render() {
    const disableButton =
      this.state.periodType === TimeRangePeriodTypes.CUSTOM &&
        ...
        <div className='ant-form-inline'>
          <div className='ant-form-item'>
            <div className='ant-form-item'>
              ...
              >
                <Option value={ TimeRangePeriodTypes.LAST_7_DAYS }>
                  {I18n.t('application.last_7_Days')}
                </Option>
                <Option value={ TimeRangePeriodTypes.LAST_14_DAYS }>
                  {I18n.t('application.last_14_Days')}
                </Option>
                <Option value={ TimeRangePeriodTypes.THIS_MONTH }>
                  {I18n.t('application.this_Month')}
                </Option>
                <Option value={ TimeRangePeriodTypes.LAST_MONTH }>
                  {I18n.t('application.last_Month')}
                </Option>
                <Option value={ TimeRangePeriodTypes.CUSTOM }>
                  {I18n.t('application.custom')}
                </Option>
              </Select>
            </div>
            ...
            <div className='ant-form-item'>
              ...
              <button
                className={
                  'btn ' + (disableButton ? 'btn-disabled' : ' btn-regular') + ' margin-left-10'
                }
                disabled={ disableButton }
