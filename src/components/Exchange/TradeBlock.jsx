...
import {RWalletUnlockActions, RTransactionConfirmActions, SendPageActions} from '../../actions';
          ...
          AssetRepository
            ...
            .then((assets) => {
              this.props.setTransaction('limit_order_create', {
                ...
                transactionFunction: this.props.transferTransaction,
...
const mapDispatchToProps = (dispatch) => bindActionCreators(
  {
    ...
    transferTransaction: SendPageActions.transferTransaction
  },
  dispatch
);

export default connect(mapStateToProps, mapDispatchToProps)(TradeBlock);