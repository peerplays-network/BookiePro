 ...
 *       touched : true if the field has been touched. By default this will be set when the field 
 * is blurred.
      ...
      <form onSubmit={ handleSubmit }>
        ...
        <div className='form-fields text-center'>
          ...
          <button
            ...
            className={
              'btn ' +
              (oldPasswordDisabled ? 'btn-disabled' : ' btn-regular') +
          ...
          <button
            ...
            className={
              'btn ' +
              (confirmBtnDisabled ? 'btn-disabled' : ' btn-regular') +
              ' grid-100 margin-top-25'
            }
...
export default reduxForm({
  ...
  validate: function submit(values) {
    ...
    errors.old_password = validateChangePasswordFields(
      values.get('old_password'),
      I18n.t('changePassword.enter_old_password'),
      minimumLengthErrorMessage
    );
    //New password validations
    errors.new_password = validateChangePasswordFields(
      new_password,
      I18n.t('changePassword.enter_new_password'),
      minimumLengthErrorMessage
    );
    //Confirm-New password validations
    errors.new_password_confirm = validateChangePasswordFields(
      new_password_confirm,
      I18n.t('changePassword.confirm_new_password'),
      minimumLengthErrorMessage
    );
