    ...
    return (
      <div className='placed-bets'>
        <div className='content' ref='placedBets'>
          ...
          { !this.props.isEmpty && <MatchedBets currencyFormat={ this.props.currencyFormat } activeTab={ this.props.activeTab } disabled={ this.props.disabled }/> }
          { this.props.isEmpty &&
            <Empty
