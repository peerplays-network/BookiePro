    ...
    if (this.props.isEmpty) {
      ...
      if (this.props.overlay === 'NO_OVERLAY') {
        ...
        if (prevProps.unmatchedBets.size !== this.props.unmatchedBets.size || 
          ...
          // If the previous unmatchedBets Map is different in size than the one we have now, then the flow has finished
          //  removing the bet from both the order book and the users bets.
          // OR
