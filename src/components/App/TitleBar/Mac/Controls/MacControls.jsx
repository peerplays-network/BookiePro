...
class Controls extends Component {
  ...
  render() {
    return (
      ...
      >
        <Close onClick={ this.props.onCloseClick } showIcon={ this.state.isOver } isWindowFocused={ this.props.isWindowFocused }/>
        <Minimize onClick={ this.props.onMinimizeClick } showIcon={ this.state.isOver } isWindowFocused={ this.props.isWindowFocused }/>
        <Resize
