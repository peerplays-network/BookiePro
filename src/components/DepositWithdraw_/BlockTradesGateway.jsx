...
export default class BlockTradesGateway extends React.Component {
  ...
  _getActiveCoin(props, state) {
    ...
    let activeCoin = cachedCoin
      ? cachedCoin
      : props.coins.length
        ? props
          .coins[0][state.action === 'withdraw'
            ? 'symbol'
            : 'backingCoinType']
          .toUpperCase()
        : null;
  ...
  changeAction(type) {
    ...
    this.setState({action: type, activeCoin: activeCoin});
  }
      ...
      <div style={ this.props.style }>
        ...
        <div style={ {paddingBottom: 15} }>
          <div
            ...
            className={ cnames('button', action === 'deposit'
              ? 'active'
              : 'outline') }>
          ...
          <div
            ...
            className={ cnames('button', action === 'withdraw'
              ? 'active'
              : 'outline') }>
