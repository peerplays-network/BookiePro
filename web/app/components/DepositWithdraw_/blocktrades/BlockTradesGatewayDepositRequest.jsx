...
export default class BlockTradesGatewayDepositRequest extends React.Component {
  ...
  addDepositAddress(receive_address) {
    ...
    this.deposit_address_cache.cacheInputAddress(
      ...
      this.props.deposit_coin_type,
      this.props.receive_coin_type,
      receive_address.address, receive_address.memo
    );
  ...
  render() {
    ...
    if (this.props.deposit_account) {
      deposit_address_fragment = (
        <span>
          <code>{this.props.deposit_account}</code>
        </span>
      );
      deposit_memo = (
        <code>
      ...
      if (receive_address.memo) {
        // This is a client that uses a deposit memo (like ethereum), we need to display
        // both the address and the memo they need to send
        deposit_address_fragment = (
          <span>
            <code>{receive_address.address}</code><br/>with memo
            <code>{receive_address.memo}</code>
          </span>
        );
      } else {
        ...
        deposit_address_fragment = (
          <span>
            <code>{receive_address.address}</code>
          </span>
        );
      }
