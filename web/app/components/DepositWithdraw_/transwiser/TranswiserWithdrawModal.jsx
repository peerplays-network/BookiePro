...
class TranswiserWithdrawModal extends React.Component {
  ...
  constructor(props) {
    ...
    let balanceAmount = null; /* eslint-disable-line */
  }
    ...
    if (asset_types.length > 0) {
      ...
      if (current_asset_id) {
        ...
        if (account_balances[current_asset_id]) {
          this.balanceAmount = parseInt(
            ChainStore.getObject(
              account_balances[current_asset_id]
            ).get('balance')) / Math.pow(10, parseInt(this.props.sellAsset.get('precision')));
        }
      } else {
        balance = 'No funds';
        ...
        <div className='grid-container'>
          ...
          <div className='content-block'>
            <AmountSelector
              ...
              display_balance={ balance }/> {this.state.balance_error
            ...
            <div className='grid-block'>
              ...
              {this.state.withdraw_amount_after_fee > 0
                ? <span> (<Translate
                  ...
                  amount={ this.state.withdraw_amount_after_fee }/>)</span>
                : null}
            </div>
          </div>
