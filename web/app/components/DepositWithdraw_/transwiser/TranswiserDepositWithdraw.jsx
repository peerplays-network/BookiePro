...
class TranswiserDepositWithdraw extends React.Component {
  ...
  constructor(props) {
    ...
    // this.apiUrl      = "http://www.transwiser.com/setting.json"; this.apiUrl
    // = "http://localhost:3000/setting-dev.json";
  }

  requestDepositUrl() {
    let pair = this.depositCoin.toLocaleLowerCase() + ':'
  ...
  getModalId() {
    return '_asset_' + this.props.issuerAccount.get('name') + '_'
    + this.props.receiveAsset.get('symbol');
  }
