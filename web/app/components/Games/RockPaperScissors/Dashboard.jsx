            ...
            {accountId
              ? <JoinTournamentButton
                ...
                joinToTournament={ this
                  .joinToTournament
                  .bind(this) }
                tournamentId={ tournamentImm.get('id') }
                accountId={ accountId }
                number_of_players={ tournamentImm.getIn(['options', 'number_of_players']) }
                whitelist={ tournamentImm.getIn(['options', 'whitelist']) }/>
              : null}
          </div>
        </div>
      );
      ...
      <div
        ...
        <div className='box-inner box-inner-2'>
          <div className='table__section'>
            <Translate
              component='div'
              className='table2__title'
              content='games.rps_game.my_scheduled_tournaments'/>
            <div className='table table2 table-pg-db1'>
              <div className='table__head tableRow'>
                ...
                <Translate
                  component='div'
                  className='tableCell'
                  content='games.rps_game.players_registered'/>
                <Translate
                  component='div'
                  className='tableCell'
                ...
                <div className='tableCell text_r'>
                  <Translate
                    ...
                    content='games.rps_game.actions'/>
                </div>
              </div>
