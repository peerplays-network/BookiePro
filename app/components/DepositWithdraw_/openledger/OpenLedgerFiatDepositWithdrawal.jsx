...
class OpenLedgerFiatDepositWithdrawCurrency extends React.Component {
  ...
  render() {
    ...
    let wallet = WalletDb.getWallet(); /* eslint-disable-line */
    ...
    if (this.props.deposit_allowed) {
      ...
      deposit_fragment = (
        <td>Click
        <a href='https://openledger.info/v/' target='_blank'> {/* eslint-disable-line */}
          here
          </a>
    ...
    if (this.props.withdraw_allowed) {
      ...
      withdraw_fragment = (
        <td>Click
          <a href='https://openledger.info/v/'>
            here
          </a>
          to register for withdrawals
        </td>
      );
    }
